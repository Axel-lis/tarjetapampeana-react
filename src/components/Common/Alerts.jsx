...
const Alerts = ({ type, message }) => {
  const alertStyles = {
    ...
    warning: 'bg-orange-200 text-yellow-700 border-yellow-500',
    info: 'bg-blue-200 text-blue-700 border-blue-500',
  };
  ...
  return (
    <div className={`px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg ${alertStyles[type]}`}>
