...
import miercolesIMG from '../../assets/images/paravos-grid/03.png';
...
/*promos*/
import img1Promo from '../../assets/banners/promociones/DOMIN-D.png';
import img2Promo from '../../assets/banners/promociones/LUNES-D.png';
import img3Promo from '../../assets/banners/promociones/MARTE-D.png';
import img4Promo from '../../assets/banners/promociones/MIERC-D.png';
import img5Promo from '../../assets/banners/promociones/JUEVE-D.png';
import img6Promo from '../../assets/banners/promociones/VIERNES-D.png';
import img7Promo from '../../assets/banners/promociones/SABAD-D.png';
import img8Promo from '../../assets/banners/promociones/ELECTROHOGAR-D.png';
import img9Promo from '../../assets/banners/promociones/RESTAURANTES-D.png';

import img1Mobile from '../../assets/banners/promociones/DOMIN.png';
import img2Mobile from '../../assets/banners/promociones/LUNES.png';
import img3Mobile from '../../assets/banners/promociones/MARTE.png';
import img4Mobile from '../../assets/banners/promociones/MIERC.png';
import img5Mobile from '../../assets/banners/promociones/JUEVE.png';
import img6Mobile from '../../assets/banners/promociones/VIERNES.png';
import img7Mobile from '../../assets/banners/promociones/SABAD.png';
import img8Mobile from '../../assets/banners/promociones/ELECTROHOGAR.png';
import img9Mobile from '../../assets/banners/promociones/RESTAURANTES.png';
...
export const paraVosPromos = [
  ...
  { dia: 'MIÉRCOLES', reintegro: '$25.000', image: miercolesIMG },
...
/* Para tu comercio*/
export const slidesComecios = [img0, img1, img2, img3, img4, img5, img6, img7, img8, img9];
export const beneficios = [
  ...
  },
  {
    ...
    description:
      'Explorá las ventajas de nuestros planes de cuotas con tasas bonificadas que convierten a Tarjeta Pampeana en la elección destacada para tu comercio.',
  },
  {
    title: 'Descubre Nuestra Atención Personalizada',
    description:
      'Con asesores comerciales, un equipo de ventas y marketing, podemos brindarte la mejor solución para tus necesidades comerciales, operativas y técnicas.',
  },
  {
    title: 'Publicidad: Destaca tu Marca',
    description:
      'Potenciá la visibilidad de tu marca al aparecer en nuestras piezas de comunicación y destacarte en nuestro buscador de promociones.',
  },
  {
...
export const requisitosComercios = [
  {
    Requisitos: {
      'Identidad del Titular del Comercio o de su Representante': {
        'Documentos Aceptados': ['DNI', 'CI', 'LE', 'LC', 'Pasaporte'],
        Sociedades:
          'En caso de tratarse de una sociedad, el documento corresponderá al representante legal de la misma.',
      },
      ...
      'Documentación Respaldo de Situación Patrimonial y/o Impositiva': {
        Opciones: ['DDJJ de Ganancias', 'DDJJ de IVA'],
        Exenciones: 'En caso de exenciones, adjuntar las constancias correspondientes.',
      },
      Adicionales: {
        'Personas Jurídicas (Sociedades)': {
          Documentos: ['Contrato Social', 'Actas societarias que acrediten los mandatos vigentes'],
          'Representante no Designado':
            'En caso de que quien firme la solicitud de adhesión no esté designado en el contrato social como firmante o administrador, deberá presentar el poder que lo habilite.',
        },
...
export const preguntasParaVos = [
  {
    ...
    respuesta:
      'El límite de crédito inicial está conformado por una evaluación Financiero / Crediticia que se hace sobre cada individuo que solicita su Tarjeta Pampeana o Paquete Premium Gold. Dicho límite es individual y se tienen en cuenta numerosos factores, siguiendo las recomendaciones de los Bureaus de Crédito más reconocidos del país y BCRA. El límite de crédito inicial se verá modificado en función del comportamiento crediticio del titular, así como de diversos factores como nuevos ingresos, aumentos masivos, etc.',
  },
  {
    titulo: '¿Tengo un portal de autogestión para poder ver todos mis consumos y operaciones?',
    respuesta:
      '¡SI! Tarjeta Pampeana cuenta con un moderno Portal de Autogestión que te va a permitir conocer tus límites y disponibles, vencimientos, últimos resúmenes y toda la información de tus productos y operaciones. También te va a permitir realizar solicitudes de préstamo, adhesión a débito automático y muchos más beneficios para disfrutar al máximo de tu tarjeta. Visítalo en: https://online.pampeana.com.ar.',
  },
  {
    titulo: '¿Tarjeta Pampeana tiene un Programa de Puntos y Recompensas?',
    respuesta:
      '¡Por supuesto! Desde Tarjeta Pampeana premiamos que nos elijas cada día y por ello tenemos vigente un exclusivo Plan de Premios & Recompensas que te permite sumar puntos con cada resumen. Podes cambiar tus puntos acumulados fácilmente por los productos que más te gusten de nuestro Catálogo de Premios. Consulta nuestro catálogo en nuestro Portal de Autogestión: https://online.pampeana.com.ar.',
  },
  {
    titulo: '¿Dónde puedo ver los comercios adheridos para comprar con Pampeana?',
    respuesta:
      "Podrás visualizar los comercios adheridos desde el menú superior de la página, en la sección 'Dónde comprar'. Una vez allí debes seleccionar la provincia donde intentes buscar la promoción y luego tendrás una tabla de los locales adheridos.",
  },
  {
    titulo: '¿Qué medios de pagos acepta Tarjeta Pampeana?',
    respuesta:
      "Tarjeta Pampeana acepta como medios de pago: Pampa Pagos, Provincia Net, nuestro Portal de Autogestión y la adhesión a débito automático. Podrás encontrar más información sobre medios de pago aceptados en el menú superior 'Para vos' -> Medios de pago.",
  },
];
export const preguntasComercios = [
  ...
  },
  {
    ...
    respuesta:
      'Cada comercio podrá optar por diferentes modalidades de cobro de sus liquidaciones adaptándose a las necesidades de cada uno. Pudiendo cobrar cada 7 o 30 días mediante transferencia bancaria. Cada Plazo de pago tiene una tasa de adelanto de fondos diferentes.',
  },
  {
    titulo: '¿Cuándo se pagan las liquidaciones de mis ventas?',
    respuesta:
      'Se pagan en días hábiles pactados oportunamente desde la fecha de presentación. Acreditaremos en su cuenta bancaria el total neto de arancel, retenciones impositivas e intereses si correspondiera, de las operaciones presentadas y aceptadas hasta el cierre del mes anterior.',
  },
  {
    titulo: '¿Puedo solicitar un Préstamo para Capital de Trabajo?',
    respuesta:
      'Si, una vez transcurrido 6 meses de estar operando con Tarjeta Pampeana en su comercio, podrá solicitar un préstamo de capital de trabajo para invertir en su negocio y hacerlo crecer. Mediante la página web ó directamente en la aplicación de consultas de las liquidaciones verá la opción disponible.',
  },
  {
...
export const slidesPromosMobile = [
  img1Mobile,
  img2Mobile,
  img3Mobile,
  img4Mobile,
